...
enum eConfigUInt32Values
{
    ...
    CONFIG_WARRIOR_BOT_BATTLE_SHOUT,
    CONFIG_PALADIN_BOT_AURA,
    CONFIG_PALADIN_BOT_BLESSING,
    CONFIG_HUNTER_BOT_TRUE_SHOT_AURA,
    CONFIG_PRIEST_BOT_POWER_WORD_FORTITUDE,
    CONFIG_PRIEST_BOT_DIVINE_SPIRIT,
    CONFIG_PRIEST_BOT_SHADOW_PROTECTION,
    CONFIG_SHAMAN_BOT_TOTEM,
    CONFIG_MAGE_BOT_ARCANE_INTELLECT,
    CONFIG_WARLOCK_BOT_DETECT_INVISIBILITY,
    CONFIG_DRUID_BOT_MARK_OF_THE_WILD,
    CONFIG_DRUID_BOT_THORNS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_ITEM_LEVEL_MC,
    CONFIG_FLOAT_ITEM_LEVEL_OL,
    CONFIG_FLOAT_ITEM_LEVEL_BWL,
    CONFIG_FLOAT_ITEM_LEVEL_ZG,
