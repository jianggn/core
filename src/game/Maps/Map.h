...
struct MapEntry
{
    ...
    bool IsMountAllowed() const { return !IsDungeon() || id == MAP_ZUL_GURUB || id == MAP_ZUL_FARRAK || id == MAP_AHN_QIRAJ_RUINS || id == MAP_CAVERNS_OF_TIME || id == MAP_AZSHARA_CRATER || id == 542 || id == 543 || id == 544 || id == 545 || id == 546 || id == 554; }
